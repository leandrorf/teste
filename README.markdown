...
Este módulo possui casos de uso para validar funcionalidades do sistema no processo de abertura e fechamento de turno.
****

[TOC]

## Abrir e fechar um turno apenas com OperadorA
...
## Abrir e fechar um turno apenas com OperadorB
### Objetivo
~~~~
Validar a abertura e fechamento de turno usando apenas o cartão do Motorista para a operação
~~~~
...
## Abrir e fechar um turno com OperadorA e OperadorB
### Objetivo
~~~~
Validar a abertura e fechamento de turno usando apenas o cartão do Motorista para a operação
~~~~
...
## Abrir e fechar um turno com cartão Caixa
### Objetivo
~~~~
Validar a abertura e fechamento de turno usando apenas o cartão do Motorista para a operação
~~~~
...
## Abrir e fechar um turno com cartão Caixa e OperadorB
### Objetivo
~~~~
Validar a abertura e fechamento de turno usando apenas o cartão do Motorista para a operação
~~~~
...
## Abrir e fechar um turno com cartão Caixa, OperadorA e OperadorB
### Objetivo
~~~~
Validar a abertura e fechamento de turno usando apenas o cartão do Motorista para a operação
~~~~
